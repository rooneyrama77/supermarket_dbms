...
res.sendFile('login.jpg', {root: __dirname });

});

app.get('/logingif.gif', function (req, res) {

res.sendFile('logingif.gif', {root: __dirname });
